...
const Introduction = () => {
  return (
    <div className="relative bg-cover bg-center min-h-screen flex items-center px-4 md:px-20">
      {/* Background Images */}
      ...
      {/* Content Section */}
      <div className="relative text-white max-w-lg z-10 space-y-4 md:space-y-6 mt-40 md:mt-20">
        {/* Title with Stars */}
        ...
        <a
          href="#"
          className="inline-flex items-center justify-center w-full md:w-2/4 bg-white hover:bg-blue-600 text-blue-600 hover:text-white font-bold py-3 md:py-4 px-4 md:px-6 rounded-lg transition duration-300 text-sm md:text-lg"
        >
          Contact Us ➔
        </a>
      </div>
